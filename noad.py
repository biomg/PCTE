...
class PCTE(nn.Module):
    def __init__(self, hidden_dim=510,
        ...
        self.relu = nn.ReLU()
        self.linear1 = nn.Linear(1020, 500)
        nn.init.xavier_normal_(self.linear1.weight, gain=1)
    ...
    def forward(self, inputs):
        ...
        hidden_states_one = hidden_states_one[0, :, :]
        hidden_states_two = hidden_states_two[0, :, :]
        ...
        return self.linear2(self.relu(self.linear1(tf)))
